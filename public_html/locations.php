            ...
            <div id="myTabContent" class="tab-content">
                ...
                <div class="tab-pane fade" id="cowles_gym">
					...
					<div class="modal fade" id="enlargephoto5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
					    ...
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel5">The Dungeon</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					...
					<div class="modal fade" id="enlargephoto6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
					    ...
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel6">Equipment Gate</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	    ...
	    <footer class="footer" style="margin-bottom: 10px;">
	      <div class="container">
	        <span class="text-muted">&copy; 2017-2018 Simpson Ghost Hunters</span>
	      </div>
	    </footer>
