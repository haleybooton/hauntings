...
<html lang="en">
  ...
  <body>
    ...
    <h1><img src="img/logo.jpg" alt="logo">Welcome!</h1>
        ...
        <img src="img/home_new.png" alt="Equipment Gate">
...
<ul>
    ...
    <li><a href="cowles_gym.php">Cowles Gym</a></li>
    <li><a href="college_hall.php">College Hall</a></li>
    <li><a href="millies.php">Millie's</a></li>
    <li><a href="mary_berry.php">Mary Berry</a></li>
</ul>
</nav>
